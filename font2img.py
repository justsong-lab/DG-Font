...
parser.add_argument('--ttf_path', type=str, default='ttf', help='ttf directory')
parser.add_argument('--chara', type=str, default='character.txt', help='characters')
parser.add_argument('--save_path', type=str, default='font_images', help='images directory')
parser.add_argument('--img_size', type=int, default=80, help='The size of generated images')
parser.add_argument('--chara_size', type=int, default=70, help='The size of generated characters')
